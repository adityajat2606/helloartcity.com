...
export default function LocalPostDetailPage() {
  ...
  const detailContent = content.body || content.description || post.summary || "Details coming soon.";
  const descriptionHtml = formatRichHtml(detailContent, "Details coming soon.");
