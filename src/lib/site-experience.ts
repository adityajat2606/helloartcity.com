...
const EXPERIENCES: Record<SiteExperience["key"], SiteExperience> = {
  ...
  helloartcity: {
    ...
    fontClass: "font-sans",
    pageClass: "bg-[#fafaf9]",
    panelClass: "bg-white shadow-sm border border-stone-100",
    softPanelClass: "bg-stone-50 border border-stone-100",
    mutedClass: "text-stone-500",
    badgeClass: "bg-stone-900 text-white",
    buttonClass: "bg-stone-900 text-white hover:bg-stone-800",
    outlineButtonClass: "border border-stone-300 bg-white text-stone-700 hover:bg-stone-50",
    heroEyebrow: "Curated visual collection",
    heroDescription: "A refined gallery experience for discovering images and creative profiles.",
  },
  housesdecors: {
    key: "housesdecors",
